...
created: 2026-04-14T17:00:26.665+03:00
modified: 2026-04-14T17:00:26.666+03:00
---
...
This is required — Obsidian must load the plugin to generate its API key.
...
Write the full configuration to `data.json` using `python3`:
